...
print (re+" _____       _             ___                    ") 
print (gr+"(_   _)     (_ )          (  _ \                  ")
print (re+"  | |    __  | |   __     | (_) )  _    ___  ___  ")
print (gr+"  | |  / __ \| | / __ \   |  _ ( / _ \/  __)  __) ")
print (re+"  | | (  ___/| |(  ___/   | (_) ) (_) )__  \__  \ ")
print (gr+"  (_)  \____)___)\____)   (____/ \___/(____/____/ ")




print (cy+"Modified By Coachella")
print (cy+"version : 007")
print (cy+"Make sure you Subscribed To 🔥 Hustlers Ground 🔥 on Telegram For More Updates.")
print (cy+"https://t.me/+7EjHzPDkInMyY2Ux")
